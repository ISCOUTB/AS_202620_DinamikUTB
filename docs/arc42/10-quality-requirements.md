...
| [ADR-0005](../adr/0005-plataforma-despliegue-backend.md) | Selección de plataforma de despliegue del backend y estrategia de persistencia | *Aceptado* (2026-09-26) | Formaliza Render (Free Web Service) para el backend y Render Postgres (Free) para la persistencia en el ambiente desplegado, sobre la alternativa del servidor del laboratorio y ajustando la consecuencia operativa de ADR-0003 solo para ese ambiente. Sustenta A-01 y A-04. |
...
|---|---|---|
| [A-01](../aspectos.md#a-01---seguimiento-del-cumplimiento-de-requisitos) — Seguimiento del cumplimiento de requisitos | ADR-0001, ADR-0002, ADR-0003, ADR-0004, ADR-0005, ADR-0006 | Aceptado |
| [A-02](../aspectos.md#a-02---calculo-correcto-del-estado-de-graduacion) — Cálculo correcto del estado de graduación | ADR-0001, ADR-0002, ADR-0003, ADR-0004 | Aceptado |
| [A-03](../aspectos.md#a-03---alertas-tempranas-de-requisitos-pendientes) — Alertas tempranas | Pendiente | Pendiente |
| [A-04](../aspectos.md#a-04---disponibilidad-del-sistema) — Disponibilidad del sistema | ADR-0001, ADR-0005 | Aceptado |
| [A-05](../aspectos.md#a-05---proteccion-y-control-de-acceso-a-la-informacion-academica) — Protección y control de acceso | ADR-0001, ADR-0002 | Aceptado (la implementación de `usuarios/` sigue pendiente; ver el riesgo correspondiente en `11-risks-and-technical-debt.md`) |
