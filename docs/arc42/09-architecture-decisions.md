...
|---|---|---|
| [A-01](../aspectos.md#a-01---seguimiento-del-cumplimiento-de-requisitos) — Seguimiento del cumplimiento de requisitos | ADR-0001, ADR-0002, ADR-0003, ADR-0004 | Aceptado |
...
Toda decisión que module la estructura del monolito, cambie una tecnología permitida por 02-architecture-constraints.md, o afecte la forma de cumplir un escenario de calidad de 10-quality-requirements.md, será registrada como un nuevo ADR en docs/adr/. Esto incluye, en particular, cualquier cambio futuro de motor de base de datos respecto a lo fijado en ADR-0003, el mecanismo de almacenamiento del historial que aún debe resolverse para A-08, y cualquier cambio del modelo síncrono de comunicación fijado en ADR-0004 (por ejemplo, si A-03 llegara a requerir procesamiento asíncrono).
